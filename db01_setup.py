...
def main():
    ...
    try:
        ...
        run_sql_file(connection, SQL_CREATE_FOLDER.joinpath('01_drop_table.sql'))
        run_sql_file(connection, SQL_CREATE_FOLDER.joinpath('02_create_tables.sql'))
        run_sql_file(connection, SQL_CREATE_FOLDER.joinpath('03_insert_records.sql'))
